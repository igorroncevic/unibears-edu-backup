...
export default {
    ...
    fields: [
        ...
        },
        {
            ...
            validation: (Rule) =>
                Rule.required().error('Course must have a slug.'),
        },
        {
            name: 'author',
            title: 'Author',
        ...
        },
        {
            ...
            validation: (Rule) =>
                Rule.required()
                    .max(3)
                    .error(
                        'Course must have at least 1 and up to 3 categories.'
                    ),
        },
        {
            name: 'bannerPhoto',
        ...
        },
        {
            ...
            title: 'Topics',
            description:
                'Topics are used to group lectures under a similar theme.',
            type: 'array',
            of: [{ type: 'topic' }],
            validation: (Rule) =>
        ...
        },
        {
            ...
            description:
                'Used for displaying course length in the details page.',
            type: 'number',
            validation: (Rule) =>
                Rule.required()
                    .min(0)
        ...
        },
        {
            ...
            validation: (Rule) =>
                Rule.required()
                    ...
                    .max(10)
                    .error(
                        'Course must have a number of required collection items.'
                    ),
        },
    ],
