...
function Lecture() {
    return (<>
        <div className="container min-vh-100 nomargin nopadding">
            <div className="row">
                <div className="col">
                    <div className="container nopadding">
                        <div className="row">
                            ...
                            <div className="col-auto nopadding"> <button type="button" className="btn btn-primary">Primary</button></div>
                        </div>
                    </div>
                </div>
                <div className="col">
                    <h2 className="font-weight-light">Hello Bootstrap 5 😊</h2>
                    <p>
                        This is a Bootstrap 5 beta starter example snippet!
                    </p>
                </div>
            </div>
        </div>
